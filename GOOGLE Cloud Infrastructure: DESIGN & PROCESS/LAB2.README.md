...
Opened the Load Balancer external IP address.

### Result

Application successfully ran on Kubernetes with three replicas.
...
Cloud Run generated a public URL:

```text
https://hello-cloud-run-356447962226.europe-west1.run.app
```
